...
if (!worksCss.includes('.lookbook') || !worksCss.includes('@media (max-width:900px)')) {
  fail('Lavori responsive stylesheet incomplete');
}
...
console.log('Static QA PASS — Home 01 + Services 02 + Lavori 03.');
